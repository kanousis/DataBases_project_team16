...
class EditdataFrame(tk.Frame):
    ...
    def create_content(self,member_id):
        ...
        address_entry.grid(row=3,column=3,pady=10)
        address_label.grid(row=3,column=2,padx=5)
        phone_entry.grid(row=4,column=3,pady=10)
        phone_label.grid(row=4,column=2,padx=5)
